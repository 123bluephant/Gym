...
const GymFinder = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Enhanced Header */}
      <header className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {userLocation && (
            <motion.div
              ...
              className="mt-6 inline-flex items-center bg-indigo-700 bg-opacity-80 px-4 py-2 rounded-full text-sm shadow-md"
            >
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 -mt-10">
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
            <div className="flex-grow relative">
              ...
              <input
                type="text"
                id="search"
                className="block w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 border text-base"
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200"
            >
        ...
        {loading && (
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="mt-4 text-gray-600">Finding the best gyms near you...</p>
            </div>
          </motion.div>
        )}
              ...
              {filteredGyms.length > 0 ? (
                filteredGyms.map((gym) => (
                  <motion.div
                    ...
                    className="bg-white shadow-md rounded-xl overflow-hidden cursor-pointer border border-gray-100 transition-all duration-200 hover:shadow-lg"
                  ...
                  >
                    {gym.photo_url && (
                      <div className="h-48 overflow-hidden relative">
                        ...
                        <span className={`absolute top-3 right-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    ...
                    <div className="p-5">
                      <div className="flex items-center mb-3">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            key={i}
                            className={`h-5 w-5 ${i < Math.floor(gym.rating) ? 'text-yellow-400' : 'text-gray-300'}`}
                      ...
                      <button className="mt-4 w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
                        View Details
                      </button>
                    </div>
                  </motion.div>
