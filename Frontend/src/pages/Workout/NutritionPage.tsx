...
const NutritionService = {
  ...
  async addMealToUserDiet(mealId, mealType, day) {
...
const NutritionPage = () => {
  ...
  // Days of the week
  const daysOfWeek = [
    { key: 'monday', label: 'Monday', short: 'Mon', color: 'from-red-500 to-pink-500', bgColor: 'from-red-50 to-pink-50', textColor: 'text-red-700' },
    { key: 'tuesday', label: 'Tuesday', short: 'Tue', color: 'from-orange-500 to-yellow-500', bgColor: 'from-orange-50 to-yellow-50', textColor: 'text-orange-700' },
    { key: 'wednesday', label: 'Wednesday', short: 'Wed', color: 'from-green-500 to-emerald-500', bgColor: 'from-green-50 to-emerald-50', textColor: 'text-green-700' },
    { key: 'thursday', label: 'Thursday', short: 'Thu', color: 'from-blue-500 to-cyan-500', bgColor: 'from-blue-50 to-cyan-50', textColor: 'text-blue-700' },
    { key: 'friday', label: 'Friday', short: 'Fri', color: 'from-purple-500 to-violet-500', bgColor: 'from-purple-50 to-violet-50', textColor: 'text-purple-700' },
    { key: 'saturday', label: 'Saturday', short: 'Sat', color: 'from-indigo-500 to-blue-500', bgColor: 'from-indigo-50 to-blue-50', textColor: 'text-indigo-700' },
    { key: 'sunday', label: 'Sunday', short: 'Sun', color: 'from-pink-500 to-rose-500', bgColor: 'from-pink-50 to-rose-50', textColor: 'text-pink-700' }
  ];
  ...
  const handleAddMealToUserDiet = async (meal, mealType, day) => {
    try {
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-green-600 via-emerald-600 to-blue-600 text-white py-24 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 animate-float-slow" style={{ animationDelay: '0s' }}>
            <ChefHat className="w-12 h-12 text-white/40 drop-shadow-lg" />
          </div>
          <div className="absolute top-1/3 right-1/4 animate-float-slow" style={{ animationDelay: '1s' }}>
            <Target className="w-10 h-10 text-white/40 drop-shadow-lg" />
          </div>
          <div className="absolute bottom-1/4 left-1/3 animate-float-slow" style={{ animationDelay: '2s' }}>
            <BookOpen className="w-11 h-11 text-white/40 drop-shadow-lg" />
          </div>
          <div className="absolute top-1/2 right-1/3 animate-float-slow" style={{ animationDelay: '0.5s' }}>
            <TrendingUp className="w-9 h-9 text-white/40 drop-shadow-lg" />
          </div>
          <div className="absolute top-3/4 right-1/2 animate-float-slow" style={{ animationDelay: '3s' }}>
            <Calendar className="w-8 h-8 text-white/40 drop-shadow-lg" />
          </div>
          <div className="absolute bottom-1/3 right-1/4 animate-float-slow" style={{ animationDelay: '4s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center relative z-10">
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
              ...
              <span className="text-sm font-semibold text-green-100 tracking-wide">TRANSFORM YOUR NUTRITION TODAY</span>
            </div>
            ...
            <div className="flex justify-center space-x-8 mb-12 animate-fade-in-up animation-delay-2000">
              <div className="text-center">
                <div className="text-3xl font-bold text-white animate-count-up">1000+</div>
                <div className="text-sm text-green-200 font-medium">Healthy Recipes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white animate-count-up animation-delay-500">50K+</div>
                <div className="text-sm text-green-200 font-medium">Happy Users</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white animate-count-up animation-delay-1000">24/7</div>
                <div className="text-sm text-green-200 font-medium">Support</div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Everything You Need on My Website</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Plan your meals for the entire week and track your nutrition goals with our intuitive drag-and-drop interface
            </p>
          </div>
              ...
              <table className="w-full min-w-full">
                <thead className="bg-gradient-to-r from-purple-50 via-pink-50 to-blue-50 border-b-2 border-purple-100">
                  <tr>
                    ...
                    {daysOfWeek.map((day) => (
                      <th key={day.key} className="px-4 py-6 text-center text-sm font-bold text-gray-900 min-w-48 border-r-2 border-purple-100 last:border-r-0">
                        <div className="flex flex-col items-center space-y-2">
                          <span className="hidden sm:inline font-bold text-lg text-gray-800">{day.label}</span>
                          <span className="sm:hidden font-bold text-lg text-gray-800">{day.short}</span>
                          <div className={`text-sm font-bold text-white bg-gradient-to-r ${day.color} px-3 py-1.5 rounded-full shadow-sm`}>
                ...
                <tbody className="divide-y-2 divide-purple-50">
                  {['breakfast', 'lunch', 'dinner'].map((mealType) => (
                    <tr key={mealType} className="hover:bg-gradient-to-r hover:from-purple-25 hover:to-pink-25 transition-all duration-300 group">
                      <td className="px-8 py-10 text-sm font-bold text-gray-900 capitalize bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 border-r-2 border-purple-100">
                        <div className="flex items-center space-x-4">
                          <div className={`w-4 h-4 rounded-full shadow-sm ${
                            ...
                            mealType === 'lunch' ? 'bg-gradient-to-r from-orange-400 to-red-400' : 
                      ...
                      {daysOfWeek.map((day) => (
                        <td key={`${mealType}-${day.key}`} className="px-4 py-10 text-sm border-r-2 border-purple-100 last:border-r-0 align-top">
                          <div className="space-y-3 min-h-32">
                            {userDiet[day.key][mealType].length > 0 ? (
                              userDiet[day.key][mealType].map((meal) => (
                                <div key={meal.id} className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-2 border-green-200 rounded-xl p-4 relative group hover:shadow-lg hover:scale-105 transition-all duration-300 hover:border-green-300">
                                  <button
                                  ...
                                  <div className="font-bold text-gray-900 text-sm mb-2 pr-6 leading-tight">{meal.name}</div>
                              ...
                              <div className="text-center text-gray-400 text-sm py-12 border-2 border-dashed border-gray-300 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 hover:border-purple-300 hover:bg-gradient-to-br hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group">
                                <div className="flex flex-col items-center space-y-2">
                                  ...
                                  <span className="font-medium">No meal planned</span>
                                  <span className="text-xs text-gray-500">Add meals below</span>
                                </div>
                              </div>
                            )}
                          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden backdrop-blur-sm bg-white/95">
            <div className="p-8 bg-gradient-to-r from-purple-50 via-pink-50 to-blue-50 border-b-2 border-purple-100">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Available Meals</h3>
                  <p className="text-gray-700 mt-1 font-medium">Click the colorful day buttons to add meals to your weekly plan</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="grid lg:grid-cols-3 gap-10">
                {['breakfast', 'lunch', 'dinner'].map((mealType) => (
                  <div key={mealType} className="space-y-6 bg-gradient-to-br from-gray-50/50 to-white p-6 rounded-2xl border border-gray-100">
                    ...
                    {meals[mealType]?.length > 0 ? (
                      <div className="space-y-4">
                        {meals[mealType].map((meal) => (
                          <div key={meal.id} className="p-6 bg-gradient-to-br from-white to-gray-50 rounded-2xl hover:shadow-xl transition-all duration-300 relative border-2 border-gray-200 hover:border-purple-300 group hover:scale-[1.02] hover:bg-gradient-to-br hover:from-purple-50/30 hover:to-pink-50/30">
                            <div className="mb-5">
                              <h5 className="font-bold text-gray-900 mb-3 text-lg leading-tight group-hover:text-purple-800 transition-colors">{meal.name}</h5>
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-700">
                                ...
                                <span className={`px-3 py-1.5 rounded-full text-sm font-bold shadow-sm ${
                                  meal.difficulty === 'Easy' ? 'bg-gradient-to-r from-green-100 to-green-200 text-green-800' :
                                  meal.difficulty === 'Medium' ? 'bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800' :
                      ...
                      <div className="text-center py-12 text-gray-500 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-dashed border-gray-300">
                        <div className="flex flex-col items-center space-y-4">
                          ...
                          <span className="font-medium">No meals available for {mealType}</span>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-800 via-blue-800 to-purple-800 bg-clip-text text-transparent">Nutrition Analytics</h2>
                    <p className="text-gray-600 mt-1 font-medium">Track your daily nutrition goals and progress</p>
                  </div>
                </div>
                <div className="hidden md:flex items-center space-x-4">
                  <div className="bg-gradient-to-r from-green-100 to-emerald-100 px-4 py-2 rounded-full border border-green-200">
                    <span className="text-sm font-bold text-green-700">Weekly Overview</span>
                  </div>
                  <div className="bg-gradient-to-r from-blue-100 to-cyan-100 px-4 py-2 rounded-full border border-blue-200">
                    <span className="text-sm font-bold text-blue-700">Real-time Tracking</span>
                  </div>
                </div>
              </div>
                ...
                {(() => {
                  ...
                  const totals = Object.values(userDiet).reduce((acc, dayMeals) => {
                    ...
                    return allDayMeals.reduce((dayAcc, meal) => ({
                      ...
                      fiber: dayAcc.fiber + (meal.fiber || Math.round(meal.carbs * 0.1)),
                      sugar: dayAcc.sugar + (meal.sugar || Math.round(meal.carbs * 0.3))
                    }), acc);
                  ...
                  return mainMacros.map((macro) => {
                    ...
                    return (
                      <div key={macro.name} className="group relative">
                        <div className={`absolute inset-0 bg-gradient-to-br ${macro.color} rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-all duration-500`}></div>
                        <div className={`relative bg-gradient-to-br ${macro.bgColor} rounded-3xl p-8 border-2 border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 backdrop-blur-sm`}>
                          <div className="flex items-start justify-between mb-6">
                            <div className={`w-14 h-14 bg-gradient-to-br ${macro.color} rounded-2xl flex items-center justify-center shadow-lg`}>
                              <IconComponent className="w-7 h-7 text-white" />
                            </div>
                            <div className="text-right">
                              <div className="text-3xl font-bold text-gray-800 mb-1">{macro.value.toFixed(0)}</div>
                              <div className="text-sm font-medium text-gray-600">{macro.unit}</div>
                            </div>
                          </div>
                          
                          <div className="mb-4">
                            <h3 className="text-lg font-bold text-gray-800 mb-1">{macro.name}</h3>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-between text-xs text-gray-600">
                              <span>0</span>
                              <span className="font-medium">Target: {macro.target.toFixed(0)} {macro.unit}</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-br from-white/80 to-gray-50/80 rounded-2xl p-8 border border-gray-200/50 shadow-lg backdrop-blur-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                  {(() => {
                    ...
                    return [
                      { name: 'Calories', value: totals.calories, unit: 'kcal', color: 'from-rose-400 to-pink-500', target: dailyCaloriesGoal * 7 },
                      { name: 'Protein', value: totals.protein, unit: 'g', color: 'from-blue-400 to-indigo-500', target: (dailyCaloriesGoal * 0.15 / 4) * 7 },
                      { name: 'Carbs', value: totals.carbs, unit: 'g', color: 'from-green-400 to-emerald-500', target: (dailyCaloriesGoal * 0.55 / 4) * 7 },
                      { name: 'Fats', value: totals.fats, unit: 'g', color: 'from-yellow-400 to-orange-500', target: (dailyCaloriesGoal * 0.30 / 9) * 7 },
                      { name: 'Fiber', value: totals.fiber, unit: 'g', color: 'from-purple-400 to-violet-500', target: 25 * 7 },
                      { name: 'Sugar', value: totals.sugar, unit: 'g', color: 'from-pink-400 to-rose-500', target: 50 * 7 }
                    ].map((macro) => {
                      const percentage = (macro.value / macro.target) * 100;
                      return (
                        <div key={macro.name} className="bg-gradient-to-br from-white to-gray-50/50 rounded-2xl p-6 border border-gray-200/80 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 group">
                          <div className="flex items-center justify-between mb-4">
                            <div className={`w-5 h-5 bg-gradient-to-r ${macro.color} rounded-full shadow-sm group-hover:scale-110 transition-transform duration-300`}></div>
                          ...
                          <div className="text-xs text-gray-500 mb-3">{macro.unit}</div>
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/50 shadow-sm">
                  ...
                  <div className="text-3xl font-bold text-green-700 mb-1">
                    {Object.values(userDiet).reduce((total, day) => 
                      total + day.breakfast.length + day.lunch.length + day.dinner.length, 0
                    )}
                  </div>
                  <p className="text-sm text-green-600">Total meals this week</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200/50 shadow-sm">
                  ...
                  <div className="text-3xl font-bold text-blue-700 mb-1">
                    {Object.values(userDiet).filter(day => 
                ...
                <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl p-6 border border-purple-200/50 shadow-sm">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-purple-800">Avg Daily Calories</h4>
                  </div>
                  <div className="text-3xl font-bold text-purple-700 mb-1">
                    {(() => {
                      const totalCalories = Object.values(userDiet).reduce((total, day) => {
                        const dayMeals = [...day.breakfast, ...day.lunch, ...day.dinner];
                        return total + dayMeals.reduce((dayTotal, meal) => dayTotal + meal.calories, 0);
                      }, 0);
                      const plannedDays = Object.values(userDiet).filter(day => 
                        day.breakfast.length > 0 || day.lunch.length > 0 || day.dinner.length > 0
                      ).length;
                      return plannedDays > 0 ? Math.round(totalCalories / plannedDays) : 0;
                    })()}
                  </div>
      ...
      <section className="relative py-24 bg-gradient-to-br from-emerald-600 via-teal-600 to-blue-700 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-16 left-16 w-32 h-32 border-2 border-white rotate-45 animate-spin" style={{ animationDuration: '20s' }}></div>
          <div className="absolute bottom-16 right-16 w-24 h-24 border-2 border-white rotate-12 animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }}></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-emerald-100 max-w-4xl mx-auto leading-relaxed mb-4 animate-fade-in-up animation-delay-500">
              Join <span className="font-bold text-white bg-white/20 px-3 py-1 rounded-full">12,000+</span> people who've achieved their health goals with our personalized meal planning system.
            </p>
            
            {/* Success Stats */}
            <div className="flex flex-wrap justify-center gap-8 mb-12 animate-fade-in-up animation-delay-1000">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1 animate-count-up animation-delay-1500">95%</div>
                <div className="text-sm text-emerald-200 font-medium">Success Rate</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1 animate-count-up animation-delay-2000">30 Days</div>
                <div className="text-sm text-emerald-200 font-medium">Average Results</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1 animate-count-up animation-delay-2500">1000+</div>
                <div className="text-sm text-emerald-200 font-medium">Healthy Recipes</div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-fade-in-up animation-delay-2000">
            ...
            <div className="flex justify-center items-center space-x-2 mb-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className={`w-10 h-10 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full border-2 border-white flex items-center justify-center text-white font-bold text-sm animate-bounce`} style={{ animationDelay: `${i * 0.1}s` }}>
                    {String.fromCharCode(64 + i)}
                  </div>
                ))}
              </div>
              <div className="ml-4 text-emerald-100 text-sm">
                <span className="font-bold">Sarah, Mike, Alex</span> and <span className="font-bold">11,997 others</span> joined this week
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-fade-in-up animation-delay-3000">
            <div className="flex flex-col items-center text-white/60">
              ...
              <span className="text-xs mt-2 font-medium">Scroll to explore</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden">
          <svg className="relative block w-full h-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25" fill="currentColor" className="text-gray-50">
              <animateTransform
                attributeName="transform"
                attributeType="XML"
                type="translate"
            ...
            <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" opacity=".5" fill="currentColor" className="text-gray-50">
              <animateTransform
                attributeName="transform"
                attributeType="XML"
                type="translate"
            ...
            <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" fill="currentColor" className="text-gray-50">
              <animateTransform
                attributeName="transform"
                attributeType="XML"
                type="translate"
